 ...
 function TextForm(prop) {
  ...
  return (
    <>
      ...
      <h1>{prop.heading} </h1>
      <div className="mb-3">
        <textarea className="form-control" value={Text} onChange={MyclickOnchange} id="My Text Box" rows="4"></textarea><br />
        <button className="btn btn-primary mx-2" onClick={Myupclick}> Convert Uppercase </button>
        <button className="btn btn-primary mx-2" onClick={Myloclick}>Convert Lowercase </button>
